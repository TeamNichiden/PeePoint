            ...
            for line in dataLines {
                ...
                if components.count == 32 {
                    ...
                    let toilet = PublicToilet(
                        ...
                        installationLocation: components[9],
                        latitude: Double(components[12]) ?? 0.0,
                        longitude: Double(components[11]) ?? 0.0,
